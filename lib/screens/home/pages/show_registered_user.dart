...
class ShowRegisteredUsersPage extends StatefulWidget {
  static const nameRoute = '/showregisterpage';
  @override
  _ShowRegisteredUsersPageState createState() =>
      _ShowRegisteredUsersPageState();
}
    ...
    await showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
              'The encrypted password for "$username" is:\n\n$encryptedPassword'),
          actions: <Widget>[
            TextButton(
              onPressed: () {
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ListTile(
                  ...
                  onTap: () {
                    _showEncryptedPasswordDialog(context,
                        _users[index]['username'], _users[index]['password']);
                  },
                  trailing: IconButton(
